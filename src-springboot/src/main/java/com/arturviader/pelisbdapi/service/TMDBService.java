...
public interface TMDBService {
    ...
    MoviesResponseTMDB getPopularMovies(int page);
    MoviesResponseTMDB getTrendingMovies(String timeWindow, int page);
    SeriesResponseTMDB getPopularTvShows(int page);
    SeriesResponseTMDB getTrendingTvShows(String timeWindow, int page);
    MoviesResponseTMDB searchMovie(String query, int page);
    ...
    GenreDetailMoviesTMDB getGenreDetail(Long genreId, int page, int limit);
